...
class AdvertiseSearch extends Advertise
{
    ...
    {
        return [
            [['id', 'idUser', 'phone', 'fewDays', 'namberOfVisits', 'showOn', 'agree', 'alarm', 'idAlarm', 'fewHoursAlarm', 'finalAgree', 'enable', 'priceAdvertise', 'priceAlarm', 'priceFull'], 'integer'],
            [['title', 'urlImgOrMovie', 'shortDiscripton', 'text', 'startDate', 'endDate'], 'safe'],
        ];
    }
